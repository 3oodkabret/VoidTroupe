            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              >
                <span className="relative z-10 flex items-center gap-2">
                  {t("home.page.beginAnalysis")} <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {TRAITS.map((trait, i) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-2 text-foreground">{t(`traits.${trait.id}`)}</h3>
                <p className="text-muted-foreground text-sm leading-relaxed">
                  {t(`traitsDescriptions.${trait.id}`)}
                </p>
              </div>
            ))}
          </div>
